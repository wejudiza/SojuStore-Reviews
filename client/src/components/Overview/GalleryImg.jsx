...
function GalleryImg(props) {
  ...
  return (
    <div id="default-thumbnails">
      <div>
      <i className={props.index > 0 ? 'leftArrow' : 'leftArrow-hidden'} style={{visibility: 'visible', position: 'absolute', left: '1.3%', top: '50%'}} onClick={() => changeBackwardLeft()}> </i>
      <i className={props.index === maxThumbIndex - 1 ? 'rightArrow-hidden' : 'rightArrow'} style={{visibility: 'visible', position: 'absolute', left: '47%', top: '50%'}} onClick={() => changeForwardRight()}> </i>
      <div>
