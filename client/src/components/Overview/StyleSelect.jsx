...
function StyleSelect (props) {
  ...
  return (
    <div id ="whole-Style">
      ...
      {defaultStyle.sale_price === null ? <div style={{margin: '1.5%', fontSize: '19px', width: '50%', display: 'flex', order: '3', justifyContent: 'center', alignSelf: 'flex-end'}}> $ {defaultStyle.original_price} </div> : <div style={{margin: '1.5%', fontSize:'19px', justifyContent: 'center', display: 'flex'}}> <b style={{color:'red', weight: '600'}}>${defaultStyle.sale_price}</b><strike> $ {defaultStyle.original_price} </strike> </div> }
      </div>
